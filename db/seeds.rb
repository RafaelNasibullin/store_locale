...
5.times do
  Category.create(name_en: Faker::Food.ingredient,
  	       			 name_ru: Faker::Food.spice)
  5.times do
  	Product.create(title_en: Faker::Cat.breed,
  								 title_ru: Faker::Commerce.department,
  								 description_en: Faker::Lorem.sentence,
  								 description_ru: Faker::Lorem.sentence,
  								 price: Faker::Number.between(1, 10),
  								 category_id: Category.last.id,
  								 image: File.open(File.join(Rails.root.join('public', 'test'), 'test.jpg')))
  end
end
